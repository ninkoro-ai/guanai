...
def build():
    ...
    # ---------- 5 生日提醒 ----------
    h1(doc, "5  生日提醒")
    add_figure(doc, "06-reminders.png", "图 9  提醒页（提前 7 天提醒与家属生日）")
    h2(doc, "5.1  提前 7 天提醒")
    ...
    add_note(doc, "暂缓上线", "“当天提醒（A 类客户三次）”因当前为纯网页应用、暂无系统通知权限，无法真正定时触达，暂缓上线；待接入推送/通知能力后再恢复。本段功能说明保留供后续参考。")
    h2(doc, "5.3  提醒开关")
    para(doc, "可在“设置 → 提醒设置”中分别开启或关闭“提前 7 天提醒”与“当天提醒”。")
    add_note(doc, "暂缓上线", "设置页的“提醒设置”板块已随“当天提醒”一并暂缓移除；“提前 7 天提醒”保持默认开启，首页与提醒页仍会正常展示。")
    ...
    para(doc, "设置页按类别分组展示，共三组：账户与团队、演示模式、数据管理。")
    h2(doc, "8.1  账户与团队")
    ...
    add_note(doc, "暂缓上线", "因网页应用暂无系统通知权限，“当天提醒（A 类客户三次）”暂缓上线，设置页的“提醒设置”板块已随之移除；“提前 7 天提醒”保持默认开启。本段功能说明保留供后续接入推送能力后恢复。")
    h2(doc, "8.6  隐私与版权")
