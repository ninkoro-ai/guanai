...
def build():
    ...
    para(doc, "客户详情页集中展示客户完整信息（编号、性别、行业、生日、距离生日天数、备注），并提供“编辑客户 / 生成祝福 / 完成维护”快捷操作。“家属关系”模块可登记客户家属（夫妻 / 子女 / 父母 / 其他）：既能关联系统内已有客户（点击家属姓名可直接跳转到对方详情页），也能仅登记姓名与备注，用于客户家庭关系维护。“历史维护记录”模块按时间倒序展示该客户过往全部维护记录，每条记录包含维护日期与内容，可直接在此二次编辑。")
    h2(doc, "4.4  编辑与删除客户")
    ...
    qa = [
        ...
        ("如何登记客户家属？", "进入客户详情页 → “家属关系” → 新增家属，选择关系类型（夫妻 / 子女 / 父母 / 其他），可关联系统内已有客户或仅填写姓名与备注。"),
